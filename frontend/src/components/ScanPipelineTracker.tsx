        ...
        <div className="pt-4 border-t border-zinc-800 space-y-3 font-mono">
          ...
          <div className="flex items-center justify-between text-xs">
            <div className="flex items-center gap-2 text-zinc-200">
              ...
              <span className="text-zinc-500 font-sans text-xs sm:inline hidden">
                — {activeStageObj.desc}
              </span>
            </div>
          ...
          {/* Precision Horizontal Progress Bar with Sweep Effect */}
          <div className="relative w-full h-2 rounded-full bg-zinc-850 overflow-hidden border border-zinc-800">
            <div
              className="h-full bg-gradient-to-r from-zinc-500 via-zinc-300 to-white rounded-full transition-all duration-500 ease-out"
              ...
              return (
                <div
                  ...
                  className={`p-2 rounded border text-left transition-all ${
                    isCurrent
                      ? "bg-zinc-850 border-zinc-650 text-white shadow-sm"
                      : isPast
                      ? "bg-[#0b0e14] border-zinc-800 text-zinc-400"
                      : "bg-[#0b0e14]/50 border-zinc-850 text-zinc-600"
                  }`}
                >
